...
const navigation = {
  services: [
    ...
    { name: 'Complete Renovations', href: '/services/renovations' },
  ],
  company: [
...
const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://facebook.com/premierconstructionco',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/premierconstructionco',
    icon: (
      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/premierconstructionco',
    icon: (
      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 border-t border-gray-800 pt-8">
          <div className="flex flex-col items-center justify-between md:flex-row">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Premier Construction & Remodeling.
              All rights reserved.
            </p>
